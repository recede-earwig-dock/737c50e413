...
var settings = {
	...
	time_dl_max: 72, // max duration of download test in seconds
	...
	xhr_dlMultistream: 16, // number of download streams to use (can be different if enable_quirks is active)
